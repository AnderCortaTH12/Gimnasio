...
- Name: qa\qa-flow.spec.ts >> Paso 4 - Iniciar entrenamiento, añadir ejercicios
- Location: qa\qa-flow.spec.ts:144:1
...
Call log:
  - waiting for getByTestId('lista-ejercicios').locator('button').first()
